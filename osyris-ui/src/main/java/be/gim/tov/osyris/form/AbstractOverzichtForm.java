...
@Named
@ViewScoped
public abstract class AbstractOverzichtForm implements Serializable {
	private static final long serialVersionUID = 3676671150227033873L;

	private static final Log LOG = LogFactory
			.getLog(AbstractOverzichtForm.class);
	...
	public boolean hasPermission() {
		return identity.hasPermission("", getAction());
	}
	...
	public boolean isCanCreate() {
		return isCanEdit(object)
				...
				&& !"File".equals(getModelClass().getName());
	}
